...
try:
	...
	print("\033[91mThe OS->BUILD->TRAMPOLINE_BASE_PATH key is not set correctly in the oil file ECU2_ICM.oil.")
	print("Set the correct Trampoline installation path in the oil file and run goil again:\033[0m")
	print("goil -t=avr/arduino/nano --templates=../../../goil/templates/ ECU2_ICM.oil")
	sys.exit(1)
...
#--- Add generated files
sourceList.append("ECU2_ICM/tpl_app_config.c")

sourceList.append("ECU2_ICM/tpl_dispatch_table.c")
sourceList.append("ECU2_ICM/tpl_invoque.S")
sourceList.append("ECU2_ICM/tpl_interrupts.c")
