 ...
 * Automatically generated by goil on Mon Jun 12 17:46:16 2023
 * from root OIL file ECU4_TCM.oil
 *
...
CONST(tpl_appmode_mask, OS_CONST) tpl_alarm_app_mode[ALARM_COUNT] = {
  1 /* alarm periodicAlarm : stdAppmode */ ,
...
/* Alarm periodicAlarm identifier */
#define periodicAlarm_id 0
CONST(AlarmType, AUTOMATIC) periodicAlarm = periodicAlarm_id;
...
#include "tpl_memmap.h"
tpl_stack_word M1_stack_zone[256/sizeof(tpl_stack_word)];
...
#define M1_STACK { M1_stack_zone, 256 }
...
#include "tpl_memmap.h"
tpl_stack_word M2_stack_zone[256/sizeof(tpl_stack_word)];
...
#define M2_STACK { M2_stack_zone, 256 }
 ...
 */
/*-----------------------------------------------------------------------------
 * Alarm periodicAlarm descriptor
 *
...
CONST(tpl_task_activation_action, OS_CONST) periodicAlarm_action = {
  {
...
CONST(tpl_alarm_static, OS_CONST) periodicAlarm_static = {
  {
    /* pointer to counter           */  &SystemCounter_counter_desc,
    /* pointer to the expiration    */  tpl_raise_alarm
#if (WITH_ID == YES)
    /* id of the alarm for tracing  */  , periodicAlarm_id
#endif
#if WITH_OSAPPLICATION == YES
    /* OS application id            */  , 
#endif
  },
  /* action of the alarm  */  (tpl_action *)&periodicAlarm_action
};
...
VAR(tpl_time_obj, OS_VAR) periodicAlarm_alarm_desc = {
    /* pointer to the static part   */  (tpl_time_obj_static *)&periodicAlarm_static,
    /* next alarm                   */  NULL,
    /* prev alarm                   */  NULL,
    /* cycle                        */  200,
    /* date                         */  200,
