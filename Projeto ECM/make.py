...
try:
	...
	print("\033[91mThe OS->BUILD->TRAMPOLINE_BASE_PATH key is not set correctly in the oil file ECU1_ECM.oil.")
	print("Set the correct Trampoline installation path in the oil file and run goil again:\033[0m")
	print("goil -t=avr/arduino/nano --templates=../../../goil/templates/ ECU1_ECM.oil")
	sys.exit(1)
...
#--- Add generated files
sourceList.append("ECU1_ECM/tpl_app_config.c")

sourceList.append("ECU1_ECM/tpl_dispatch_table.c")
sourceList.append("ECU1_ECM/tpl_invoque.S")
sourceList.append("ECU1_ECM/tpl_interrupts.c")
