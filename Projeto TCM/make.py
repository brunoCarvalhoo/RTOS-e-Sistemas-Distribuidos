...
try:
	...
	print("\033[91mThe OS->BUILD->TRAMPOLINE_BASE_PATH key is not set correctly in the oil file ECU4_TCM.oil.")
	print("Set the correct Trampoline installation path in the oil file and run goil again:\033[0m")
	print("goil -t=avr/arduino/nano --templates=../../../goil/templates/ ECU4_TCM.oil")
	sys.exit(1)
...
#--- Add generated files
sourceList.append("ECU4_TCM/tpl_app_config.c")

sourceList.append("ECU4_TCM/tpl_dispatch_table.c")
sourceList.append("ECU4_TCM/tpl_invoque.S")
sourceList.append("ECU4_TCM/tpl_interrupts.c")
