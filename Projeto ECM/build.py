...
#--- OIL file
oilSourceList.append("ECU1_ECM.oil")
...
cSourceList.append(projfile.ProjectFile("ECU1_ECM.cpp"))

#--- Add generated files
cSourceList.append(projfile.ProjectFile("ECU1_ECM/tpl_app_config.c"))

cSourceList.append(projfile.ProjectFile("ECU1_ECM/tpl_dispatch_table.c"))
cSourceList.append(projfile.ProjectFile("ECU1_ECM/tpl_invoque.S"))
cSourceList.append(projfile.ProjectFile("ECU1_ECM/tpl_interrupts.c"))
...
if True:
  postCommand = makefile.PostCommand("Generating binary image_ECM.hex from image_ECM")
  postCommand.mCommand.append(r"avr-objcopy")
  postCommand.mCommand += "-O ihex".split()
  postCommand.mCommand.append("image_ECM")
  postCommand.mCommand.append("image_ECM.hex")
...
if make.errorCount() == 0:
  if askedGoal == "flash" :
    ...
    if makefile.find_executable("avrdude") != None:
      print("\033[1m\033[95mFlashing image_ECM on avr/arduino/nano\033[0m")
