...
#--- OIL file
oilSourceList.append("ECU4_TCM.oil")
...
cSourceList.append(projfile.ProjectFile("ECU4_TCM.cpp"))

#--- Add generated files
cSourceList.append(projfile.ProjectFile("ECU4_TCM/tpl_app_config.c"))

cSourceList.append(projfile.ProjectFile("ECU4_TCM/tpl_dispatch_table.c"))
cSourceList.append(projfile.ProjectFile("ECU4_TCM/tpl_invoque.S"))
cSourceList.append(projfile.ProjectFile("ECU4_TCM/tpl_interrupts.c"))
...
if True:
  postCommand = makefile.PostCommand("Generating binary image_ECU4_TCM.hex from image_ECU4_TCM")
  postCommand.mCommand.append(r"avr-objcopy")
  postCommand.mCommand += "-O ihex".split()
  postCommand.mCommand.append("image_ECU4_TCM")
  postCommand.mCommand.append("image_ECU4_TCM.hex")
...
if make.errorCount() == 0:
  if askedGoal == "flash" :
    ...
    commandLine += "image_ECU4_TCM.hex "
    ...
    if makefile.find_executable("avrdude") != None:
      print("\033[1m\033[95mFlashing image_ECU4_TCM on avr/arduino/nano\033[0m")
