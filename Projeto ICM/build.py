...
#--- OIL file
oilSourceList.append("ECU2_ICM.oil")
...
cSourceList.append(projfile.ProjectFile("ECU2_ICM.cpp"))

#--- Add generated files
cSourceList.append(projfile.ProjectFile("ECU2_ICM/tpl_app_config.c"))

cSourceList.append(projfile.ProjectFile("ECU2_ICM/tpl_dispatch_table.c"))
cSourceList.append(projfile.ProjectFile("ECU2_ICM/tpl_invoque.S"))
cSourceList.append(projfile.ProjectFile("ECU2_ICM/tpl_interrupts.c"))
...
if True:
  postCommand = makefile.PostCommand("Generating binary image_ECU2_ICM.hex from image_ECU2_ICM")
  postCommand.mCommand.append(r"avr-objcopy")
  postCommand.mCommand += "-O ihex".split()
  postCommand.mCommand.append("image_ECU2_ICM")
  postCommand.mCommand.append("image_ECU2_ICM.hex")
...
if make.errorCount() == 0:
  if askedGoal == "flash" :
    ...
    commandLine += "image_ECU2_ICM.hex "
    ...
    if makefile.find_executable("avrdude") != None:
      print("\033[1m\033[95mFlashing image_ECU2_ICM on avr/arduino/nano\033[0m")
